# TODO: Pydantic models: DateInfo, PersonalInfo, WorkExperience, Project, Education, PortfolioData
...
class DateInfo(BaseModel):
    ...
    year: Optional[int] = Field(
        None, ge=1900, le=2100, description="4-digit year")
...
class Education(BaseModel):
    """Education entry with structured dates."""
...
class PortfolioData(BaseModel):
    """Root portfolio data model with structured sections."""
